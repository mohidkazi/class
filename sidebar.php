            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="studentd">
                        <li>
                            <a href="student.php" id="student">Student</a>
                        </li>
                        <li>
                            <a href="attendence.php" id="attendence">Attendence</a>
                        </li>
                        <li>
                            <a href="add-testmark.php" id="addtestmark">Add Marks</a>
                        </li>
                        <li>
                            <a href="testmark.php" id="testmark">Test Marks</a>
                        </li>
                        <li>
                            <a href="payment.php" id="payment">Payment</a>
                        </li>
                    </ul>
                </li>
                <li>
